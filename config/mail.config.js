                        ...
                        <tr>
                            <td style="text-align:center;">
                              <a href="http://localhost:4200" title="logo" target="_blank">
                                <img width="200" src="https://nf1-expertise.net/media/uploads/nl/locations/previews/og/logo_UMCG_transparant2.png?_=1591783184" title="logo" alt="logo">
                              </a>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Beste `+ username + ` </h1>
                                            <span
                                            ...
                                            <a href="` + config.frontendUrl + `/reset/` + resetToken.toString() + `"
